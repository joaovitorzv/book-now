...
let User = (_dec = (0, _typeorm.Entity)('users'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = (0, _typeorm.Column)(), _dec4 = (0, _typeorm.Column)(), _dec5 = (0, _typeorm.Column)(), _dec6 = (0, _classTransformer.Exclude)(), _dec7 = (0, _typeorm.CreateDateColumn)(), _dec8 = (0, _typeorm.UpdateDateColumn)(), _dec(_class = (_class2 = class User {
  ...
  password = _initializerWarningHelper(_descriptor4, this);
  created_at = _initializerWarningHelper(_descriptor5, this);
  updated_at = _initializerWarningHelper(_descriptor6, this);
