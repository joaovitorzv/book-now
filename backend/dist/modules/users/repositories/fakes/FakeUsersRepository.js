...
var FakeUsersRepository = /** @class */ (function () {
    ...
    FakeUsersRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                user = this.users.find(function (userStored) { return userStored.id === id; });
                return [2 /*return*/, user];
            });
        });
    };
    FakeUsersRepository.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                user = this.users.find(function (userStored) { return userStored.email === email; });
                return [2 /*return*/, user];
            });
        });
    };
    FakeUsersRepository.prototype.findAllProviders = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                users = this.users;
                if (except_user_id) {
                    users = this.users.filter(function (usersStored) { return usersStored.id !== except_user_id; });
                }
